...
const readXLSX = () => {
  ...
  try {
    ...
    for(let r = EXCEL_START_ROW_INDEX; r < EXCEL_END_ROW; r++) {
      ...
      const r_pride = getCellValue(3, r);
      const r_link2 = getCellValue(4, r);
      const r_link3 = getCellValue(5, r);
      ...
      const r_syokusyus = getListValue(6);
      const r_gakubus = getListValue(7);
      const r_bunyas = getListValue(8);
      const r_kodawaris = getListValue(9);
